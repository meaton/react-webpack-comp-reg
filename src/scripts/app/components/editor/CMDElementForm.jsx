          ...
          {open && (
            <div className="panel-body">
              <div className="form-horizontal form-group">
                ...
                <DocumentationInput name="Documentation" label="Documentation" value={elem['Documentation']} onChange={this.updateElementValueWithDefault.bind(this, "")}  labelClassName="editorFormLabel" wrapperClassName="editorFormField" />
