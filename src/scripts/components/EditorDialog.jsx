...
var ConceptRegistryModal = React.createClass({
  ...
  render: function() {
    var tableClasses = classNames('table', 'table-bordered', 'table-stripped', 'table-condensed');
    var conceptRegCols = [
      {
        property: 'name',
        header: 'Name'
    ...
    return (
      <Modal id="myModal" className="registry-dialog" title={this.props.title} backdrop={false} animation={false} onRequestHide={this.props.onRequestHide} container={this.props.container}>
        <div className='modal-body'>
          ...
          <Table columns={conceptRegCols} data={conceptRegData} className={tableClasses} />
        </div>
        <div className="modal-footer">
